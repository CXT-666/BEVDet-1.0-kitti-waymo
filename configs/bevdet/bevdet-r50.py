...
model = dict(
    ...
    test_cfg=dict(
        pts=dict(
            ...
            # nms_thr=[0.11, 0.11, 0.11, 0.2, 0.08, 0.25],
...
data = dict(
    ...
    val=dict(ann_file=data_root + 'nuscenes_infos_train.pkl', pipeline=test_pipeline, classes=class_names,
        modality=input_modality, img_info_prototype='bevdet'),
    test=dict(ann_file=data_root + 'nuscenes_infos_train.pkl',pipeline=test_pipeline, classes=class_names,
        modality=input_modality, img_info_prototype='bevdet'))
